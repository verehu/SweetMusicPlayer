...
class LocalAlbumFragment : BaseFragment(), IMusicViewTypeContain {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        adapter!!.setOnItemClickListener { view, position ->
            startActivity(LocalMusicActivity.getStartActIntent(mAct, IMusicViewTypeContain.SHOW_MUSIC_BY_ALBUM,
