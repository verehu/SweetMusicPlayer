...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    //add by jerry
    public static abstract class OnRefreshDownListener<V extends View> implements OnRefreshListener2{
        public void onPullUpToRefresh(final PullToRefreshBase refreshView){

        };
    }

    public static abstract class OnLoadUpListener<V extends View> implements OnRefreshListener2{
